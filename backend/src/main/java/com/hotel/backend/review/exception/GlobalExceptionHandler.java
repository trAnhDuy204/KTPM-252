package com.hotel.backend.review.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<AuthDto.ApiError> handleReviewException(ReviewException e) {
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .body(AuthDto.ApiError.builder()
                        .status(HttpStatus.BAD_REQUEST.value())
    ...
    public ResponseEntity<AuthDto.ApiError> handleNotFound(ResourceNotFoundException e) {
        return ResponseEntity
