      ...
      <div className="w-full max-w-lg rounded-2xl bg-card shadow-xl border border-edge overflow-hidden">
        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            ...
            <input
              className="w-full text-zinc-950 rounded-lg border border-edge  px-3 py-2 text-sm text-hi outline-none transition focus:border-info"
              value={formData.name || ""}
              onChange={(e) =>
          ...
          <div>
            ...
            <textarea
              className="w-full text-zinc-950 rounded-lg border border-edge  px-3 py-2 text-sm text-hi outline-none transition focus:border-info resize-none h-24"
